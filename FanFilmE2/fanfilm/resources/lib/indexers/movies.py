...
class movies:
    def __init__(self):
        ...
        self.person_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&production_status=released&role=%s&sort=' + moviessort + '&count=40&start=1'
        self.keyword_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&keywords=%s&sort=' + moviessort + '&count=40&start=1'
        self.theaters_link = 'https://www.imdb.com/search/title?title_type=feature&num_votes=1000,&release_date=date[120],date[0]&sort=' + moviessort + '&count=40&start=1'
...
#       self.year_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=100,&production_status=released&year=%s,%s&sort=' + moviessort + '&count=40&start=1'

        if self.hidecinema == 'true':
            self.popular_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=1000,&production_status=released&groups=top_1000&release_date=,' + self.hidecinema_date + '&sort=moviemeter,asc&count=40&start=1'
            self.views_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=1000,&production_status=released&sort=num_votes,desc&release_date=,' + self.hidecinema_date + '&count=40&start=1'
            self.featured_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=1000,&production_status=released&release_date=date[365],date[90]&sort=' + moviessort + '&count=40&start=1'
            self.genre_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,' + self.hidecinema_date + '&genres=%s&sort=' + moviessort + '&count=40&start=1'
            self.language_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=100,&production_status=released&primary_language=%s&sort=' + moviessort + '&release_date=,' + self.hidecinema_date + '&count=40&start=1'
            self.certification_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=100,&production_status=released&certificates=us:%s&sort=' + moviessort + '&release_date=,' + self.hidecinema_date + '&count=40&start=1'
            self.boxoffice_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&production_status=released&sort=boxoffice_gross_us,desc&release_date=,' + self.hidecinema_date + '&count=40&start=1'
            self.thcenturyfox_link = 'https://www.imdb.com/search/title?companies=fox&production_status=released&title_type=feature,tv_movie&release_date=,' + self.hidecinema_date + '&sort=' + moviessort + '&count=40&start=1'
            self.dreamworks_link = 'https://www.imdb.com/search/title?companies=dreamworks&production_status=released&title_type=feature,tv_movie&release_date=,' + self.hidecinema_date + '&sort=' + moviessort + '&count=40&start=1'
            self.mgm_link = 'https://www.imdb.com/search/title?companies=mgm&production_status=released&title_type=feature,tv_movie&release_date=,' + self.hidecinema_date + '&sort=' + moviessort + '&count=40&start=1'
            self.paramount_link = 'https://www.imdb.com/search/title?companies=paramount&production_status=released&title_type=feature,tv_movie&release_date=,' + self.hidecinema_date + '&sort=' + moviessort + '&count=40&start=1'
            self.sony_link = 'https://www.imdb.com/search/title?companies=sony&production_status=released&title_type=feature,tv_movie&release_date=,' + self.hidecinema_date + '&sort=' + moviessort + '&count=40&start=1'
            self.universal_link = 'https://www.imdb.com/search/title?companies=universal&production_status=released&title_type=feature,tv_movie&release_date=,' + self.hidecinema_date + '&sort=' + moviessort + '&count=40&start=1'
            self.waltdisney_link = 'https://www.imdb.com/search/title?companies=disney&production_status=released&title_type=feature,tv_movie&release_date=,' + self.hidecinema_date + '&sort=' + moviessort + '&count=40&start=1'
            self.warnerbross_link = 'https://www.imdb.com/search/title?companies=warner&production_status=released&title_type=feature,tv_movie&release_date=,' + self.hidecinema_date + '&sort=' + moviessort + '&count=40&start=1'
            ...
            self.featured_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=1000,&production_status=released&release_date=date[365],date[60]&sort=' + moviessort + '&count=40&start=1'
            self.genre_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie,documentary&num_votes=100,&release_date=,date[0]&genres=%s&sort=' + moviessort + '&count=40&start=1'
            self.language_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=100,&production_status=released&primary_language=%s&sort=' + moviessort + '&count=40&start=1'
            self.certification_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=100,&production_status=released&certificates=us:%s&sort=' + moviessort + '&count=40&start=1'
            ...
            self.thcenturyfox_link = 'https://www.imdb.com/search/title?companies=fox&production_status=released&title_type=feature,tv_movie&sort=' + moviessort + '&count=40&start=1'
            self.dreamworks_link = 'https://www.imdb.com/search/title?companies=dreamworks&production_status=released&title_type=feature,tv_movie&sort=' + moviessort + '&count=40&start=1'
            self.mgm_link = 'https://www.imdb.com/search/title?companies=mgm&production_status=released&title_type=feature,tv_movie&sort=' + moviessort + '&count=40&start=1'
            self.paramount_link = 'https://www.imdb.com/search/title?companies=paramount&production_status=released&title_type=feature,tv_movie&sort=' + moviessort + '&count=40&start=1'
            self.sony_link = 'https://www.imdb.com/search/title?companies=sony&production_status=released&title_type=feature,tv_movie&sort=' + moviessort + '&count=40&start=1'
            self.universal_link = 'https://www.imdb.com/search/title?companies=universal&production_status=released&title_type=feature,tv_movie&sort=' + moviessort + '&count=40&start=1'
            self.waltdisney_link = 'https://www.imdb.com/search/title?companies=disney&production_status=released&title_type=feature,tv_movie&sort=' + moviessort + '&count=40&start=1'
            self.warnerbross_link = 'https://www.imdb.com/search/title?companies=warner&production_status=released&title_type=feature,tv_movie&sort=' + moviessort + '&count=40&start=1'
        ...
        self.y50_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1950-01-01,1959-12-31&sort=moviemeter,asc'
        self.y60_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1960-01-01,1969-12-31&sort=moviemeter,asc'
        self.y70_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1970-01-01,1979-12-31&sort=moviemeter,asc'
        self.y80_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1980-01-01,1989-12-31&sort=moviemeter,asc'
        self.y90_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1990-01-01,1999-12-31&sort=moviemeter,asc'
        self.y2000_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=2000-01-01,2009-12-31&sort=moviemeter,asc'
        self.y2010_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=2010-01-01,date[90]&sort=moviemeter,asc'
    ...
    def search(self):
        ...
        for (id, term) in dbcur.fetchall():
            if term not in str(lst):
                delete_option = True
                navigator.navigator().addDirectoryItem(term, 'movieSearchterm&name=%s' % term, 'search.png',
                                                       'DefaultMovies.png')
                lst += [(term)]
        dbcur.close()
    ...
    def years_top(self):
        self.list.append(
            {'name': '[I]Lata 50[/I] - [B]1950 - 1959[/B]', 'url': 'y50', 'image': 'years.png', 'action': 'movies'})
        self.list.append(
            {'name': '[I]Lata 60[/I] - [B]1960 - 1969[/B]', 'url': 'y60', 'image': 'years.png', 'action': 'movies'})
        self.list.append(
            {'name': '[I]Lata 70[/I] - [B]1970 - 1979[/B]', 'url': 'y70', 'image': 'years.png', 'action': 'movies'})
        self.list.append(
            {'name': '[I]Lata 80[/I] - [B]1980 - 1989[/B]', 'url': 'y80', 'image': 'years.png', 'action': 'movies'})
        self.list.append(
            {'name': '[I]Lata 90[/I] - [B]1990 - 1999[/B]', 'url': 'y90', 'image': 'years.png', 'action': 'movies'})
        self.list.append(
            {'name': '[I]Lata 2000[/I] - [B]2000 - 2009[/B]', 'url': 'y2000', 'image': 'years.png', 'action': 'movies'})
        self.list.append(
            {'name': '[I]Lata 2010[/I] - [B]2010 - 2019[/B]', 'url': 'y2010', 'image': 'years.png', 'action': 'movies'})
        self.addDirectory(self.list)
        return self.list

    def awards(self):
        self.list.append({'name': 'Oscary - najlepszy film', 'url': 'oscarsbestmovie', 'image': 'oscar-winners.png',
                          'action': 'movies'})
        self.list.append(
            {'name': 'Oscary - najlepszy film - nominowane', 'url': 'oscarsbestmovienom', 'image': 'oscar-winners.png',
             'action': 'movies'})
        self.list.append({'name': 'Oscary - najlepszy reżyser', 'url': 'oscarsbestdir', 'image': 'oscar-winners.png',
                          'action': 'movies'})
        self.list.append(
            {'name': 'Oscary - najlepszy reżyser - nominowane', 'url': 'oscarsbestdirnom', 'image': 'oscar-winners.png',
             'action': 'movies'})
        self.list.append(
            {'name': 'Oscary - wszystkie kategorie', 'url': 'oscars', 'image': 'oscar-winners.png', 'action': 'movies'})
        self.list.append(
            {'name': 'Oscary - wszystkie kategorie - nominowane', 'url': 'oscarsnom', 'image': 'oscar-winners.png',
             'action': 'movies'})
        self.list.append({'name': 'Złote Maliny', 'url': 'razzie', 'image': 'razzie_winners.png', 'action': 'movies'})
        self.list.append({'name': 'Złote Maliny - nominowane', 'url': 'razzienom', 'image': 'razzie_winners.png',
                          'action': 'movies'})
        self.addDirectory(self.list)
        return self.list
    ...
    def companies(self):
        self.list.append(
            {'name': '20th Century Fox', 'url': 'thcenturyfox', 'image': '20thcenturyfox.png', 'action': 'movies'})
    ...
    def worker(self, level=1):
        ...
        self.fanart_tv_headers = {'api_key': '5e25a4f74a746c953314066acfcbe64d'}
    ...
    def super_info(self, i):
        try:
            ...
            try:
                ...
                art = client.request(self.fanart_tv_art_link % imdb + "?api_key=%s&client_key=%s" % (
                '5e25a4f74a746c953314066acfcbe64d', self.fanart_tv_user), headers=self.fanart_tv_headers, timeout='10',
                                     error=True)
                try:
                    art = json.loads(art)
                except:
