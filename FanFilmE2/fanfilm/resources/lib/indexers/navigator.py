...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem(32007, 'channels', 'calendar.png', 'DefaultMovies.png')
        ...
        if traktCredentials == True:
            self.addDirectoryItem(32620, 'movies&url=traktwatchlist', 'movies_watchlist.png', 'DefaultMovies.png',
                                  queue=True, context=(32551, 'moviesToLibrary&url=traktwatchlist'))
            self.addDirectoryItem(32621, 'tvshows&url=traktwatchlist', 'tvshows_watchlist.png', 'DefaultTVShows.png',
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem(32630, 'movieYearsTop', 'years.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem(32632, 'movieCompanies', 'companies.png', 'DefaultMovies.png')
