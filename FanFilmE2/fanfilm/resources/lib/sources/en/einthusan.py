...
class source:
    ...
    def movie(self, imdb, title, localtitle, aliases, year):
        try:
            langMap = {'hi': 'hindi', 'ta': 'tamil', 'te': 'telugu', 'ml': 'malayalam', 'kn': 'kannada',
            ...
            r = [(client.parseDOM(i, 'a', ret='href'), client.parseDOM(i, 'h3'),
                  client.parseDOM(i, 'div', attrs={'class': 'info'})) for i in r]
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            sources.append({'source': 'einthusan', 'quality': 'HD', 'language': 'en', 'url': url, 'direct': True,
                            'debridonly': False})
            return sources
        except:
            return sources
