...
class source:
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            result = \
                [i[0] for i in result if len(i[0]) > 0 and path in i[0][0] and len(i[1]) > 0 and 'Altyaz' in i[1][0]][
                    0][0]
            ...
            try:
                ...
                url = [i for i in url if
                       'ok.ru' in i or 'vk.com' in i or 'openload.io' in i or 'openload.co' in i or 'oload.tv' in i][0]
            ...
            for i in url:
                sources.append(
                    {'source': host, 'quality': i['quality'], 'language': 'en', 'url': i['url'], 'direct': direct,
                     'debridonly': False})
