    ...
    def sources(self, url, hostDict, hostprDict):
        ...
        for link_in, title_in in match2:
            if title in title_in:
                ...
                for url, q in match3:
                    self.sources2.append({'source': 'Direct', 'quality': q, 'language': 'en',
                                          'url': url + "|Referer=" + link_in + "&User-Agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.39 Safari/537.36",
