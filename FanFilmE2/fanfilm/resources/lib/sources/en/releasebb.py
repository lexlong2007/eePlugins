    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            if 'tvshowtitle' in data:
                ...
                try:
                    posts += json.loads(re.findall('({.+?})$', result)[0])['results']
                except:
                    pass
            ...
            for post in posts:
                try:
                    ...
                    try:
                        items += zip([i for i in client.parseDOM(content, 'p') if 'Release Name:' in i],
                                     [i for i in client.parseDOM(content, 'p') if '<strong>Download' in i])
                    except:
                        pass

                    try:
                        items += client.parseDOM(content, 'p', attrs={'style': '.+?'})
                    except:
                        pass
                        ...
                        try:
                            ...
                            if any(i in ['dvdscr', 'r5', 'r6'] for i in fmt):
                                quality = 'SCR'
                                    ...
                                    i in ['camrip', 'tsrip', 'hdcam', 'hdts', 'dvdcam', 'dvdts', 'cam', 'telesync',
                                          'ts']
                                    for i in fmt):
                                quality = 'CAM'
                            ...
                            for i in url: links.append(
                                {'url': i[1], 'quality': quality, 'info': info, 'host': i[0], 'cat': cat})
                        except:
                            pass
            ...
            for i in links:
                try:
                    ...
                    sources.append(
                        {'source': host, 'quality': i['quality'], 'language': 'en', 'url': url, 'info': i['info'],
