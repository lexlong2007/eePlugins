...
class source:
    ...
    def get_rows(self, r, search_type):
        ...
        for div in divs:
            ...
            if header and header[0].lower() == search_type.lower():
    ...
    def search(self, title, localtitle, year, search_type):
        try:
            titles = []
            titles.append(cleantitle.normalize(cleantitle.getsearch(title + " 3d")))
            titles.append(cleantitle.normalize(cleantitle.getsearch(localtitle + " 3d")))
