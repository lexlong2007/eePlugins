...
class source:
    ...
    def sources(self, url, hostDict, hostprDict):
        ...
        try:
            ...
            results = client.parseDOM(content, 'table', attrs={
                'class': 'table table-bordered table-striped table-hover episode'})
            ...
            for item in results:
                ...
                sources.append(
                    {'source': host, 'quality': 'SD', 'language': 'pl', 'url': video_link, 'info': '', 'direct': False,
                     'debridonly': False})
                continue
            return sources
        except:
