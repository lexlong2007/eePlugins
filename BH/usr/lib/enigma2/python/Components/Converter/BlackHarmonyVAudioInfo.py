...
class BlackHarmonyVAudioInfo(Poll, Converter, object):
    GET_AUDIO_ICON = 0
    GET_AUDIO_CODEC = 1
    ...
    def __init__(self, type):
        ...
        self.lang_stringsPL = ("pol", "Polski", "pl")
    ...
    def getLanguage(self):
        ...
        for lang in ("ger", "german", "deu"):
            if lang in languages:
                languages = _("German")
                break
        for lang in ("pol", "Polski", "pl"):
            if lang in languages:
                languages = _("Polish")
                break
        languages = languages.replace("und ", "").replace("pol ", "")
        return languages
