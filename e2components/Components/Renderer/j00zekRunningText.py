...
# examples:
#       when text too big, switch to smaller font alternateFont="Regular;42"
#       when text too big, switch to first matching font between alternateFont and font sizes useBiggestPossibleFont
#       by default is half of font size or can be defined by minFontSize="32"
#
################################################################################
...
class j00zekRunningText(Renderer):
    def __init__(self):
        ...
        if self.skinAttributes:
            ...
            for (attrib, value) in self.skinAttributes:
                if attrib == "font":
                    ...
                    if DBG: j00zekDEBUG("[j00zekRunningText:applySkin] minFontSize='%s'" % self.minFontSize)
                elif attrib == "alternateFont":
                    self.alternateFont = parseFont(value, ((1,1),(1,1)))
                    self.minFontSize = int(value.split(';')[1].strip())
                    if DBG: j00zekDEBUG("[j00zekRunningText:applySkin] alternateFont='%s', minFontSize='%s'" % (value, self.minFontSize)) 
                    ...
                    for o in options:
                        ...
                        if opt == "":
                            continue
                        elif opt == "useBiggestPossibleFont":
                            self.useBiggestPossibleFont = True
                            if DBG: j00zekDEBUG("[j00zekRunningText:applySkin] useBiggestPossibleFont enabled") 
    ...
    def changed(self, what):
        ...
        if what[0] == self.CHANGED_CLEAR:
            ...
            if self.mShown and not self.scroll_label is None:
