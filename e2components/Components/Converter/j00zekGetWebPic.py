        ...
        if os.path.exists(type):
            ...
            with open(type, 'w') as f:
                if language.getLanguage() == 'pl_PL':
                    ...
                    f.write('#      strumien rtsp: ffmpeg -i "rtsp://user:password@15.15.15.15:1234/cam/realmonitor?channel=1&subtype=1" -ss 00:00:01 -f image2 -vframes 1 /tmp/WebCam1Spanshot.jpg\n')
                    ...
                    f.write('#      for rtsp stream: ffmpeg -i "rtsp://user:password@15.15.15.15:1234/cam/realmonitor?channel=1&subtype=1" -ss 00:00:01 -f image2 -vframes 1 /tmp/WebCam1Spanshot.jpg\n')
                    f.write("#      curl 'http://193.242.215.2:8001/axis-cgi/jpg/image.cgi' -o /tmp/WebCamSpanshot.jpg\n")
