...
archiveURL='https://gitlab.com/mosz_nowy/iptv-host-xxx/-/archive/master/iptv-host-xxx-master.tar.gz'
addonName="iptv-host-xxx"
addonRoot='/tmp/iptv-host-xxx-master'
