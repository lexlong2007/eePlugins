...
'/DuckboxDisk/github/eePlugins/BHaddons/bar_blue.menu'
'/DuckboxDisk/github/eePlugins/BHaddons/bar_gold.menu'
'/DuckboxDisk/github/eePlugins/BHaddons/bar_gray.menu'
'/DuckboxDisk/github/eePlugins/BHaddons/bar_standard_light.menu'
'/DuckboxDisk/github/eePlugins/BHaddons/bar_standard.menu'
)
