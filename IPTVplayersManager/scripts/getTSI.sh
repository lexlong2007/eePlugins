...
archiveURL='https://gitlab.com/Rgysoft/iptv-host-e2iplayer/-/archive/master/iptv-host-e2iplayer-master.tar.gz'
addonName="tsiplayer"
addonRoot='/tmp/iptv-host-e2iplayer-master/IPTVPlayer'
