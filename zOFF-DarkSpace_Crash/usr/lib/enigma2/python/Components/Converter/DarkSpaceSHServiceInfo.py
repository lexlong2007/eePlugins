# Embedded file name: /usr/lib/enigma2/python/Components/Converter/SHServiceInfo.py
...
class DarkSpaceSHServiceInfo(Converter, object):
    HAS_TELETEXT = 0
    IS_MULTICHANNEL = 1
    IS_CRYPTED = 2
    IS_WIDESCREEN = 3
    ...
    def getBoolean(self):
        ...
        if not info:
            return False
        elif self.type == self.HAS_TELETEXT:
